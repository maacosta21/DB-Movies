...
const viewMoreCategoriesMobile = document.querySelector('.view-more-categories-mobile-button')
...
const catogoriesContainerList = document.querySelector('.categories-section')
const closeCategoriesListMobile = document.querySelector('.close-categories-mobile-button')
